...
import { FinOpsClientsToolbar } from "./clients-toolbar";
...
function SortLink({
  ...
  return (
    <Link href={`/finops/clients?${params.toString()}`} className="inline-flex items-center gap-1">
      {label}
...
export default async function FinOpsClientsPage({
  searchParams,
}: {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          >
            {page > 1 ? (
              <Link href={`/finops/clients?${pageParams.toString()}&page=${page - 1}`}>
